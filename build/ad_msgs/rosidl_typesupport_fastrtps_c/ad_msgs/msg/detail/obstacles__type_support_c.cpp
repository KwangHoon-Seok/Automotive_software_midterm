...
#include "ad_msgs/msg/detail/obstacles__rosidl_typesupport_fastrtps_c.h"
...
#include "ad_msgs/msg/detail/vehicle_output__functions.h"  // obstacles
...
using _Obstacles__ros_msg_type = ad_msgs__msg__Obstacles;
  ...
  // Field name: obstacles
  {
    const message_type_support_callbacks_t * callbacks =
      ...
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, ad_msgs, msg, VehicleOutput
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: obstacles
  {
    ...
    if (ros_message->obstacles.data) {
      ad_msgs__msg__VehicleOutput__Sequence__fini(&ros_message->obstacles);
    }
...
size_t get_serialized_size_ad_msgs__msg__Obstacles(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Obstacles__ros_msg_type * ros_message = static_cast<const _Obstacles__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_ad_msgs__msg__VehicleOutput(
...
static uint32_t _Obstacles__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_ad_msgs__msg__Obstacles(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_ad_msgs
size_t max_serialized_size_ad_msgs__msg__Obstacles(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_ad_msgs__msg__VehicleOutput(
  ...
  if (is_plain) {
    ...
    using DataType = ad_msgs__msg__Obstacles;
    is_plain =
      (
...
static size_t _Obstacles__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ad_msgs__msg__Obstacles(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, ad_msgs, msg, Obstacles)() {
