...
#include "ad_msgs/msg/detail/obstacles__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const ad_msgs::msg::VehicleOutput &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ad_msgs::msg::VehicleOutput &);
...
cdr_serialize(
  const ad_msgs::msg::Obstacles & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ad_msgs::msg::Obstacles & ros_message)
{
  // Member: obstacles
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: obstacles
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        ad_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_VehicleOutput(
  ...
  if (is_plain) {
    ...
    using DataType = ad_msgs::msg::Obstacles;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const ad_msgs::msg::Obstacles *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ad_msgs::msg::Obstacles *>(
    untyped_ros_message);
...
{
  return &ad_msgs::msg::typesupport_fastrtps_cpp::_Obstacles__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ad_msgs, msg, Obstacles)() {
  return &ad_msgs::msg::typesupport_fastrtps_cpp::_Obstacles__handle;
}
