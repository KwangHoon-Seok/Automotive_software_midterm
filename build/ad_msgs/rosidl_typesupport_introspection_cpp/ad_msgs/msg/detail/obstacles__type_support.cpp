...
{
  new (message_memory) ad_msgs::msg::Obstacles(_init);
}

void Obstacles_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ad_msgs::msg::Obstacles *>(message_memory);
  typed_message->~Obstacles();
}

size_t size_function__Obstacles__obstacles(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<ad_msgs::msg::VehicleOutput> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<ad_msgs::msg::VehicleOutput> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<ad_msgs::msg::VehicleOutput> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const ad_msgs::msg::VehicleOutput *>(
    get_const_function__Obstacles__obstacles(untyped_member, index));
  auto & value = *reinterpret_cast<ad_msgs::msg::VehicleOutput *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<ad_msgs::msg::VehicleOutput *>(
    get_function__Obstacles__obstacles(untyped_member, index));
  const auto & value = *reinterpret_cast<const ad_msgs::msg::VehicleOutput *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Obstacles_message_member_array[1] = {
  {
    ...
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<ad_msgs::msg::VehicleOutput>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(ad_msgs::msg::Obstacles, obstacles),  // bytes offset in struct
...
get_message_type_support_handle<ad_msgs::msg::Obstacles>()
{
  return &::ad_msgs::msg::rosidl_typesupport_introspection_cpp::Obstacles_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ad_msgs, msg, Obstacles)() {
  return &::ad_msgs::msg::rosidl_typesupport_introspection_cpp::Obstacles_message_type_support_handle;
}
