...
bool ad_msgs__msg__vehicle_input__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ad_msgs.msg._vehicle_input.VehicleInput", full_classname_dest, 39) == 0);
  }
  ad_msgs__msg__VehicleInput * ros_message = _ros_message;
  {  // steering
...
PyObject * ad_msgs__msg__vehicle_input__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("ad_msgs.msg._vehicle_input");
