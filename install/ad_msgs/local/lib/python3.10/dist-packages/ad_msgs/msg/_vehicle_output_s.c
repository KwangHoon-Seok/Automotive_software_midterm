...
bool ad_msgs__msg__vehicle_output__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("ad_msgs.msg._vehicle_output.VehicleOutput", full_classname_dest, 41) == 0);
  }
  ad_msgs__msg__VehicleOutput * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of VehicleOutput */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("ad_msgs.msg._vehicle_output");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "VehicleOutput");
