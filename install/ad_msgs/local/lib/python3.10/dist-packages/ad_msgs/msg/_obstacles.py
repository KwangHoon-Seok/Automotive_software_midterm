...
class Metaclass_Obstacles(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from ad_msgs.msg import VehicleOutput
            if VehicleOutput.__class__._TYPE_SUPPORT is None:
                VehicleOutput.__class__.__import_type_support__()
...
class Obstacles(metaclass=Metaclass_Obstacles):
    ...
    _fields_and_field_types = {
        'obstacles': 'sequence<ad_msgs/VehicleOutput>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['ad_msgs', 'msg'], 'VehicleOutput')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, VehicleOutput) for v in value) and
                 True), \
                "The 'obstacles' field must be a set or sequence and each value of type 'VehicleOutput'"
